				...
				element: {
					...
					form: {
						...
						domains: {
							...
							msg: {
								add: {
									title: "Добавление новых доменов",
									text: "Введите по одному домену на каждую строку(без http:// и слешей на конце).",
									error: "Неверно введен один или несколько доменов.<br>Домен должен быть написан без http:// и слешей на конце."
								},
								edit: {
									title: "Изменение домена",
									text: "Введите новый домен(без http:// и слешей на конце).",
									error: "Неверно введен домен.<br>Домен должен быть написан без http:// и слешей на конце."
								},
								setPriority: {
									title: "Изменение приоритета",
									text: "Введите желаемый приоритет домена.<br/>Это должно быть число от 0 до 999 999 999.",
									error: "Был неверенно введен приоритет домена.<br/>Число должно быть в промежутке от 0 до 999 999 999."
								},
								removeItem: {
									title: "Удаление домена",
									text: "Вы действительно хотите удалить домен?"
								},
								removeItems: {
									title: "Удаление страниц",
									text: "Вы действительно хотите удалить выделенные домены?"
								}
							}
						}
					}
